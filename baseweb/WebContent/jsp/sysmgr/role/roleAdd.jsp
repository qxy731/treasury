...
<table class='s1-params'>
	<tr>
		...
		<td><input id="roleId" name="newRole.roleId" validate="{required:true}"/></td>
		<td></td>
	</tr>
	<tr>
		<td><font color="red">*</font>&nbsp;角色名称 </td>
		<td><input id="roleName" name="newRole.roleName" validate="{required:true}"></input></td>
		<td></td>
	</tr>
	<tr>
		<td>角色描述 </td>
	...
	<tr>
		...
		<td><n:select codetype="valid_type" id="roleStatus" name='newRole.roleStatus' emptyOption="true" validate="{required:true}"></n:select></td>
		<td></td>
	</tr>
	<tr>
		<td>上级角色 </td>
...
<div align="center" class="div_bottom">
    <table class="table_btn">
        <tr>
           <td><input id="commit" type="button" value="提&nbsp;&nbsp;交" class="l-button"></td>
