...
<table class='s1-params'>
	<tr>
		...
		<td><input id="roleId" name="modifyRole.roleId" validate="{required:true}" readonly="readonly" value='${modifyRole.roleId}'/></td>
		<td></td>
	</tr>
	<tr>
		<td><font color="red">*</font>&nbsp;角色名称 </td>
		<td><input id="roleName" name="modifyRole.roleName" validate="{required:true}" value='${modifyRole.roleName}'></input></td>
		<td></td>
	</tr>
	<tr>
		<td>角色描述 </td>
		<td><input id="remark" name="modifyRole.remark" value='${modifyRole.remark}'></input></td>
		<td></td>
	</tr>
	<tr>
		<td><font color="red">*</font>&nbsp;角色状态 </td>
		<td><n:select codetype="valid_type" id="roleStatus" name='modifyRole.roleStatus' emptyOption="true" validate="{required:true}" value='${modifyRole.roleStatus}'></n:select></td>
		<td></td>
	</tr>
	<tr>
		<td>上级角色 </td>
		<td><input id="parentRole" name="modifyRole.parentRoleId" value='${modifyRole.parentRoleId}'></input></td>
		<td></td>
	</tr>
</table>
<div align="center" class="div_bottom">
    <table class="table_btn">
        <tr>
           ...
           <td><input id="cancel" type="button" value="取&nbsp;&nbsp;消" class="l-button"></input> </td>
        </tr>
    </table>
</div>
