         ...
         <form id="myform" action="${_CONTEXT_PATH}/AuditLog!query.action">
           ...
           <table class='params'>
                <tr>
                    ...
                    <td><input type='text' id='operStaffid' name='log.operStaffid' class='user_select'/></td>
                    <td nowrap="nowrap" align="center">执行人姓名</td>
                    <td><input type='text' id='operStaffName' name='log.operStaffName' /></td>
                ...
                <tr>
                    ...
                    <td><n:select codetype="log_biz_type" id="bizType" name='log.bizType' emptyOption="true" ></n:select></td>
                    <td align="center">操作类型</td>
                    <td><n:select codetype="log_func_type" id="funcType" name='log.funcType' emptyOption="true" ></n:select></td>
                    <td align="center">执行结果</td>
                    <td><n:select codetype="log_exec_result" id="execResult" name='log.execResult' emptyOption="true" ></n:select></td>
                </tr>
                <tr>
                     ...
                     <td align="right"><input id='query' name='query' type='button' value='执&nbsp;&nbsp;行' class='l-button'/></td>
...
$(function () {
	...
	$("#loglist").ligerGrid({
		...
		onDblClickRow:function(row,id,x) {
			...
			$.dialogBox.openDialog(url,{title:'日志详细信息',width:'640px',height:'380px'});
		}
	});
});
