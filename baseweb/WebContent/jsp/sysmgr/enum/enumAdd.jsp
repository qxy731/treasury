...
<table class="s1-params">
	<tr>
		...
		<td><input id="Text_enumId" name="po.enumId" validate="{required:true,maxlength:64}"/></td>
	</tr>
	<tr>
		<td><font class='fclass'>*&nbsp;</font>枚举名称 </td>
		<td><input id="Text_enumName" name="po.enumName" validate="{required:true,maxlength:64}"></input></td>
	</tr>
	<tr>
		<td>枚举描述 </td>
	...
	<tr>
		...
		<td><n:select codetype="yes_no" id="linkSrcFlag" name='po.linkSrcFlag' emptyOption="true" validate="{required:true,maxlength:32}"></n:select></td>
	</tr>
</table>
