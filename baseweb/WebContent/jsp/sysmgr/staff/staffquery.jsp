...
<table style="width:213px;">
    ...
    <tr>
        <td align="right" width="60px" style="background-color:#E2EAFF;">所属机构 </td><td align="left"><input type='hidden' id='ownerUnitId' name='ownerUnitId' style="width:0px;"/>
    ...
    $(function () {
     ...
     //输出表格
        $("#baselist").ligerGrid({
                ...
                { display: '所属机构', name: 'ownerUnitName',width:140, align: 'left' },
