...
<table class='s1-params'>
	<tr>
		<td align="right"><font color="red">*</font>&nbsp;员工编号 </td><td><input type='text' id='staffId' name='modifyStaff.staffId' value="${updateIn.modifyStaff.staffId}" readonly="readonly"/></td>
	</tr>
	<tr>
		<td align="right"><font color="red">*</font>&nbsp;员工姓名 </td><td><input type='text' id='staffName' name='modifyStaff.staffName' value="${updateIn.modifyStaff.staffName}"/></td>
	</tr>
	<tr>
		<td align="right">员工级别 </td><td><input type='text' id='staffLevel' name='modifyStaff.staffLevel' value="${updateIn.modifyStaff.staffLevel}"/></td>
	</tr>
	<tr>
		<td align="right"><font color="red">*</font>&nbsp;所属机构</td>
		<td><input type='hidden' id='unitId' name='modifyStaff.ownerUnitid' /><input id="unitName" name="unitName" readonly="readonly" value="${updateIn.modifyStaff.unitName}"  onclick="openSelectUnit()" class='unit_select'/></td>
	</tr>
	<tr>
		<td align="right">性别 </td><td><n:select codetype="sex" id='sex' name='modifyStaff.sex' emptyOption="true" value="updateIn.modifyStaff.sex" ></n:select></td>
	</tr>
	<tr>
		<td align="right"><font color="red">*</font>&nbsp;员工状态 </td>
		<td><n:select codetype="valid_type" id="staffStatus" name='modifyStaff.staffStatus' emptyOption="true" value="updateIn.modifyStaff.staffStatus"></n:select>
		</td>
	</tr>
</table>
