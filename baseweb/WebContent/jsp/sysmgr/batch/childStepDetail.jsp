...
<table class='s1-params' >
	<tr>
		...
		<td id='parentSelect'><n:select name="step.batchId" id="batchId"
			...
			<input type="hidden" value='新' id='insert_btn' ></input>
		</td>
		<td class='label'><font color="red">*</font>&nbsp;主步骤编号</td>
	...
	<tr>
		...
		<td class='label'><font color="red">*</font>&nbsp;子步骤编号</td>
		<td><input type='text' id='childId' name='step.childId' validate='{required:true,digits:true}' value='${step.childId}'/></td>
