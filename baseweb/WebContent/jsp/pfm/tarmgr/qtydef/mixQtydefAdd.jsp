...
<script type="text/javascript">
	...
	$(function (){
		$("#cancelBtn").click(function(){
			Utils.removeTabById("insertMixQtyTar");
		});
	});
</script>
</head>
...
<table class="params">
	<tr>
		...
		<td width="40%"><input  id="tarCodeText" name="newQtyDef.tarCodeText" type="text" disabled="disabled"/></td>
		<td align="right" width="10%"><font color='red'>*</font>适用对象:</td>
		<td width="40%">
		  <input style="width: 18px;" name="tarScopeCheck" type="checkbox" value="<%=PropDefPo.APPOBJ_ORGCODE%>" validate="{required:true}"/><%=PropDefPo.APPOBJ_ORGNAME %>&nbsp;
		  <input style="width: 18px;" name="tarScopeCheck" type="checkbox" value="<%=PropDefPo.APPOBJ_PERSONCODE%>"/><%=PropDefPo.APPOBJ_PERSONNAME %>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td >
			...
			<input type="text" name="otherProcDate" id="otherProcDate" style="display:none;"/>
		</td>
   </tr>
   <tr>
...
<tr>
<td align="center">
	<input type="button" value="确&nbsp;&nbsp;定" id="saveBtn" class="l-button" onclick="add();" />
