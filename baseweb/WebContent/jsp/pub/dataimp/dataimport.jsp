					...
					<fieldset class="queryBox" style="width: 100%;">
						...
						<table class='params'>
							<tr>
								...
								<td>文件上传部门</td>
								<td>
									<%-- <input type='hidden' id='orgCode' name='orgCode' value="${logUserInfo.dataScope}" /> 
...
function btn_downmodule_click() {
	var url = "${_CONTEXT_PATH}/jsp/pub/dataimp/dataimp_down.jsp";
...
function btn_upfile_click() {
	var url = "${_CONTEXT_PATH}/jsp/pub/dataimp/dataimp_up.jsp";
