...
comment on column SYS_ARC_GRANT.PRINCIPAL_TYPE is
'参见代码表 principal_type';
...
comment on column SYS_ENUM.ENUM_ID is
'码表类型ID';

comment on column SYS_ENUM.LINK_SRC_FLAG is
'参见代码表 link_src_flag';
...
comment on column SYS_ENUM_ITEM.ITEM_VALUE is
'码表类型值';

comment on column SYS_ENUM_ITEM.ITEM_DESC is
'码表类型值描述';
...
comment on column SYS_LOG_AUDIT.BIZ_TYPE is
'参见代码 log_biz_type';

comment on column SYS_LOG_AUDIT.FUNC_TYPE is
'参见代码 log_func_type';

comment on column SYS_LOG_AUDIT.EXEC_RESULT is
'参见代码 log_exec_result';
...
comment on column SYS_MENU.RELA_FLAG is
'参考代码表 rela_flag';

comment on column SYS_MENU.NODE_VISIBLE is
'参考代码表 yes_no';
...
comment on column SYS_ROLE.ROLE_STATUS is
'参考代码表 role_status';

--==============================================================
-- Table: SYS_ROLE_ASSIGN
--==============================================================
...
comment on column SYS_ROLE_ASSIGN.DEF_FLAG is
'参考代码表 del_flag';
...
comment on column SYS_STAFF.STAFF_STATUS is
'0 无效
1 有效
2 删除';
...
comment on column SYS_UNIT.UNIT_KIND is
'参见代码表 unit_kind';
