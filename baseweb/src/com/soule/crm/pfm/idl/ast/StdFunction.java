...
public class StdFunction implements Function {
	public static final String IDL_STD = "IDL_STD";
	
	private static final String name = "方差";
	...
	public String toSQL(String[] params) {
		...
		return IDL_STD + IDLLanguage.OPENED_BRACKET 
