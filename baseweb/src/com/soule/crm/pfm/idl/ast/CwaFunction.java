...
public class CwaFunction implements Function {
	public static final String IDL_CWA = "IDL_CWA";
	
	public static final String name ="同比增幅";
	...
	public String toSQL(String[] params) {
		...
		return IDL_CWA + IDLLanguage.OPENED_BRACKET 
