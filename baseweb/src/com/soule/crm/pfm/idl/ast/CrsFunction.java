...
public class CrsFunction implements Function {
	public static final String IDL_CRS = "IDL_CRS";
	
	public static final String name = "环比增量";
	...
	public String toSQL(String[] params) {
		...
		return IDL_CRS + IDLLanguage.OPENED_BRACKET 
