...
public class NeuUsernamePasswordAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
	...
	public static final String DEFAULT_SESSION_VALIDATE_CODE_FIELD = "validationCode";
	...
	protected void checkValidateCode(HttpServletRequest request) {
		...
		if (!StringUtils.hasLength(validateCodeParameter)
				|| !sessionValidateCode.equalsIgnoreCase(validateCodeParameter)) {
			throw new AuthenticationServiceException(
					messages.getMessage("validationCode.error"));
		}
