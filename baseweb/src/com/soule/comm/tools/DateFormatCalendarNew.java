...
public class DateFormatCalendarNew{
	...
	public static DateFormatCalendarNew getInstance(){
		if (manager == null) {
	...
	public static DateFormatCalendarNew getInstance(String date) throws ParseException{
		if (manager == null) {
			 manager = new DateFormatCalendarNew();
        }
    ...
    public static DateFormatCalendarNew getInstance(Date date){
    	if (manager == null) {
			 manager = new DateFormatCalendarNew();
        }
    ...
    public static DateFormatCalendarNew getInstance(String date,String format) throws ParseException{
    	if (manager == null) {
			 manager = new DateFormatCalendarNew();
        }
    	 manager.sdf = new SimpleDateFormat(manager.format);
